...
class Login:
    ...
    def write_file(self, js_dict: dict):
    ...
    def create_user(self, login: str, password: str) -> tuple:
    ...
    def user_login(self, login: str, password: str) -> bool:
        js_dict = self.open_file()
        try:
            return self.ph.verify(js_dict[login], password)
